  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="/login" method="post">
        ...
        <form action="${cp }/userAllList" method="get">
...
=======
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="/login" method="post">
        ...
        <label for="inputPassword" class="sr-only">Password</label>
        <input name="password" type="password" value="brown1234" id="inputPassword" class="form-control" placeholder="Password" required>
        <div class="checkbox">
          <label>
            <input type="checkbox" id="rememberme" value="remember-me"> Remember me
          </label>
  ...
  <script src="<%=request.getContextPath()%>/js/js.cookie.js"></script> <!-- cookie 관련된 기능 처리에 필요 -->
  <script>
  	$(document).ready(function(){
